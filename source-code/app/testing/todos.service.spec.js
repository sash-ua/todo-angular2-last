...
describe('todos.service. Isolate tests', function () {
    ...
    it('1.6 method simpleJsonObjValid', (testing_1.inject([todos_service_1.TodosService], function (service) {
        expect(service.simpleJsonObjValid(testObj)).toBeTruthy();
        expect(service.simpleJsonObjValid(testKey)).toBeFalsy();
    })));
    it('1.7.0 method appInit', (testing_1.inject([todos_service_1.TodosService], function (service) {
    ...
    it('1.8 method addItem', (testing_1.inject([todos_service_1.TodosService], function (service) {
        var arr = [];
        expect(service.addItem(testKey, arr)).toContain({ id: 0, value: testKey, done: false });
    })));
    it('1.9.0 method changeStates', (testing_1.inject([todos_service_1.TodosService], function (service) {
    ...
    it('1.9.1 method changeStates', (testing_1.inject([todos_service_1.TodosService], function (service) {
        var obj = [];
        var z = service.changeStates(obj, service.lSName, testKey);
    ...
    it('1.9.2 method changeStates', (testing_1.inject([todos_service_1.TodosService], function (service) {
    ...
    it('1.10 method inputValidation', (testing_1.inject([todos_service_1.TodosService], function (service) {
        expect(service.inputValidation('       ')).toBeFalsy();
        expect(service.inputValidation(testKey)).toBeTruthy();
    })));
    it('1.11.1 method highlightTodo', (testing_1.inject([todos_service_1.TodosService], function (service) {
        var z = [{ id: 0, value: "test", done: true }];
        service.highlightTodo(z, false);
        expect(z).toEqual([{ id: 0, value: "test", done: false }]);
    })));
    it('1.11.2 method highlightTodo', (testing_1.inject([todos_service_1.TodosService], function (service) {
        var z = [{ id: 0, value: "test", done: false }];
        service.highlightTodo(z, true);
        expect(z).toEqual([{ id: 0, value: "test", done: true }]);
    })));
    it('1.11.3 method highlightTodo', (testing_1.inject([todos_service_1.TodosService], function (service) {
    ...
    it('1.12.0 method edit', (testing_1.inject([todos_service_1.TodosService], function (service) {
    ...
    it('1.12-13 method edit & hideEl', (testing_1.inject([todos_service_1.TodosService], function (service) {
        var obj = [{ id: 0, value: "test", done: false }, { id: 1, value: "test", done: true }];
    ...
    it('1.14 method removeTodo', (testing_1.inject([todos_service_1.TodosService], function (service) {
        var z = [{ id: 0, value: "test", done: true }];
        service.removeTodo(z, 0);
        expect(z).toEqual([]);
    })));
    it('1.15 method matchAllAndDone, all objects have keys done: false', (testing_1.inject([todos_service_1.TodosService], function (service) {
    ...
    it('1.16 method openCloseEditable, one of needed spec, another specs 1.1 todos.component specs', (testing_1.inject([todos_service_1.TodosService], function (service) {
